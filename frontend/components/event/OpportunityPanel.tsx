    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="absolute bottom-6 right-24 z-50 bg-cyan-600 hover:bg-cyan-500 text-white rounded-full w-14 h-14 flex items-center justify-center shadow-lg shadow-cyan-600/30 transition-all hover:scale-105"
      ...
      {/* Panel */}
      {isOpen && (
        <div className="absolute bottom-6 right-24 z-50 w-[420px] max-h-[600px] bg-[#0d1424]/95 backdrop-blur-md border border-white/10 rounded-2xl shadow-2xl shadow-black/40 flex flex-col overflow-hidden">
          {/* Header */}
